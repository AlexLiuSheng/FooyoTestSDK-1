...
//import
//class FooyoBaseMapViewController: UIViewController {
//
//    var isHome = true
//    var isHomeFirst = true
//    
//    fileprivate var todaySelectedIndex = 0
//    
//    var plottedHome = false
//    var linesHome = [MGLPolylineFeature]()
//    
//    var items: [Item]?
//    
//    var viewMode = Constants.ViewMode.Map
//    var sortType: Constants.SortType? = Constants.SortType.Category
//    var filters: [Constants.FilterType]? = [.Attraction, .Restaurant, .Shop, .Show, .Stop]
//    
//    var sourcePage = Constants.PageSource.FromHomeMap
//    var overlayViewTwo: UIView! = {
//        let t = UIView()
...
//        t.font = UIFont.DefaultRegularWithSize(size: Scale.scaleY(y: 25))
//        return t
//    }()
//    
...
//    }()
//    
//    var reloadImage: UIImageView! = {
//        let t = UIImageView()
//        t.image = #imageLiteral(resourceName: "reload").imageByReplacingContentWithColor(color: .white)
...
//    var showAnnotations = [MyCustomPointAnnotation]()
//    var restaurantAnnotations = [MyCustomPointAnnotation]()
//    var shopAnnotations = [MyCustomPointAnnotation]()
//    var stopAnnotations = [MyCustomPointAnnotation]()
//    
//    var allAnnotationsBK = [MyCustomPointAnnotation]()
//    var attractionAnnotationsBK = [MyCustomPointAnnotation]()
//    var showAnnotationsBK = [MyCustomPointAnnotation]()
//    var restaurantAnnotationsBK = [MyCustomPointAnnotation]()
//    var shopAnnotationsBK = [MyCustomPointAnnotation]()
//    var stopAnnotationsBK = [MyCustomPointAnnotation]()
//    
//    var restroomAnnotations = [MyCustomPointAnnotation]()
//    var searchAnnotation: MyCustomPointAnnotation?
//    
//    var restroomSwitch: Bool = false
//    
...
//        t.layer.shadowOffset = CGSize(width: 0, height: Scale.scaleY(y: 8))
//        t.layer.shadowRadius = Scale.scaleY(y: 16)
//        t.layer.shadowOpacity = 1
//        t.alpha = 0.9
//        return t
//    }()
//    
//    var searchIconOne: UIImageView! = {
//        let t = UIImageView()
//        t.backgroundColor = .clear
//        //        t.contentMode = .scaleAspectFit
//        t.contentMode = .center
//        t.clipsToBounds = true
//        t.image = #imageLiteral(resourceName: "search")
//        return t
//    }()
...
//        return t
//    }()
//    var searchLabelOne: UILabel! = {
//        let t = UILabel()
//        t.text = "Search"
//        t.textColor = UIColor.sntGreyish
//        t.font = UIFont.DefaultRegularWithSize(size: Scale.scaleY(y: 16))
//        t.isUserInteractionEnabled = true
//        return t
//    }()
//    
//    var restroomButton: UIImageView! = {
//        let t = UIImageView()
//        t.backgroundColor = .white
//        t.layer.cornerRadius = Scale.scaleY(y: 44) / 2
...
//        return t
//    }()
//    var showMoreBtn: UIImageView! = {
//        let t = UIImageView()
//        t.image = #imageLiteral(resourceName: "dropdown_arrow_up").imageByReplacingContentWithColor(color: .white)
//        t.contentMode = .center
//        return t
//    }()
//    
...
//        //        createButton.applyGradient(colours: [UIColor.sntOrangeish, UIColor.sntTomato])
//    }
//    
...
//    
////    func loadUser() {
////        if User.awakeCurrentUserFromDefaults() {
////            debugPrint("data loaded")
////            debugPrint(User.currentUser.id)
////            debugPrint(User.currentUser.recentSearch?.count)
////            //            fetchDataAtBackground()
////        } else {
////            // Go to Map page
////            debugPrint("have nothing saved")
////            let user = User()
////            user.id = 1
////            User.currentUser = user
////            User.currentUser.saveToDefaults()
////            //            fetchDataAtBackground()
////        }
////    }
//    
