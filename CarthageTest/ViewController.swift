...
//        return t
//    }()
//    fileprivate var featureNames = ["Show On Map", "Navigation", "Create Plan", "My Plan Page", "Add To Plan"]
//    fileprivate var featureColors = ["1abc9c", "16a085", "f1c40f", "f39c12", "2ecc71", "27ae60"]
////    
//
...
//            //FooyoNavigationViewController(endCategory: "Events", endLevelOneId: 1, endLevelTwoId: 1)
//            self.navigationController?.pushViewController(vc, animated: true)
//        case 2:
